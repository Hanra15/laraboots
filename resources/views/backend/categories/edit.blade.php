        ...
        <form action="/dashboard/posts/{{ $post->slug }}" method="post" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                    id="title" required value="{{ old('title', $post->title) }}">
                @error('title')
            ...
            <div class="mb-3">
                ...
                <div class="row">
                    @if ($post->image)
                        <div class="col-md-6">
                            <h5>Current Image</h5>
                            <img src="{{ asset('storage/' . $post->image) }}" class="img-fluid mb-3 rounded d-block">
            ...
            <div class="mb-3">
                ...
                <trix-editor input="body" style="height: auto"></trix-editor>
            </div>
